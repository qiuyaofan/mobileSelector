        ...
        init: function(options) {
            ...
            var create={
                init:function(){
                    ...
                    // selector.list.find('li').height(config.height).css('line-height',config.height+'px');
                },
                //设置变量
                setParams:function(){
            ...
            $input.on('click',function(e){
                ...
                selector.confirm.on('touchstart click',function(e){
                    ...
                    $.each(selector.listUl,function(index,ele){
                        ...
                        // var id=$active.data('id')?$active.data('id'):' ';
                        // var value=$active.data('value')?$active.data('value'):' ';
                        if($active.length>0){
                            index=index+1;
                ...
                //点击取消
                selector.cancel.on('touchstart click',cancel);
                //点击遮罩取消
                selector.mask.on('touchstart click',cancel);
                ...
                if(!selector.noFirst&&config.idDefault){
                    ...
                    if(config.Linkpage){
                        ...
                        // linkMethods.initLink(defaultId);
                    }else{
                ...
                selector.listUl.each(function(index,ele){
                    ...
                    id.push(dataVal);
                    // var result=set($this,dataVal);
                    // var resultId=result.target.data('id');
                    // selector.inputBox.data('value'+pindex,dataVal);
            ...
            deffered={
                ...
                hide:function(){
                    ...
                    selector.main.addClass('down v-hide').transitionEnd(function (e) {
